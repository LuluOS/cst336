...
{  //admin submitted form to add product
  ...
  $sql = "INSERT INTO Product ( productTypeId, productName, productDesc, price, calories, healthyChoice)
  VALUES ( :productTypeId, :productName, :productDesc, :price, :calories, :healthyChoice)";
